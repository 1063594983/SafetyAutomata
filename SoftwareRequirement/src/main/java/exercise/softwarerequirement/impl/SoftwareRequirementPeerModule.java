...
import exercise.softwarerequirement.api.ISoftwareRequirementPeerModule;
 ...
 *
 */
public class SoftwareRequirementPeerModule implements ISoftwareRequirementPeerModule {
    private SoftwareRequirementModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public SoftwareRequirementPeerModule(SoftwareRequirementModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
