 ...
 */
public class SoftwareRequirementLifeCycleHandler extends DefaultModuleLifeCycleHandler {

	/**
	 * Constructor.
	 * @param module the Module this life cycle handler is instanciated for.
	 */
	public SoftwareRequirementLifeCycleHandler(SoftwareRequirementModule module) {
		super(module);
	}
