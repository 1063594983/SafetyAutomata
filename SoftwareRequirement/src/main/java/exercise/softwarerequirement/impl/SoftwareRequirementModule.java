package exercise.softwarerequirement.impl;
 ...
 * 
 */
public class SoftwareRequirementModule extends AbstractJavaModule {

	private SoftwareRequirementPeerModule peerModule = null;

	private SoftwareRequirementLifeCycleHandler lifeCycleHandler = null;
	
	private static SoftwareRequirementModule instance;

	public static SoftwareRequirementModule getInstance() {
		return instance;
	}

	@Override
	public SoftwareRequirementPeerModule getPeerModule() {
	 ...
	 */
	public SoftwareRequirementModule(IModuleContext moduleContext) {
		super(moduleContext);

		SoftwareRequirementModule.instance = this;

		this.lifeCycleHandler = new SoftwareRequirementLifeCycleHandler(this);
		this.peerModule = new SoftwareRequirementPeerModule(this, moduleContext.getPeerConfiguration());
	}
