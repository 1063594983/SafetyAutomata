...
import org.modelio.junit.api.IJUnitPeerModule;
 ...
 *
 */
public class JUnitPeerModule implements IJUnitPeerModule {
    private JUnitModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public JUnitPeerModule(JUnitModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
