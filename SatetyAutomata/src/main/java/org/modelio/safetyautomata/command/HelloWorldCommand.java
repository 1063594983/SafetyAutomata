...
public class HelloWorldCommand extends DefaultModuleCommandHandler {
	...
	public void actionPerformed(List<MObject> selectedElements, IModule module) {
		 ...
		 * IModuleUserConfiguration configuration =
		 * module.getModuleContext().getConfiguration();
		 * 
		 ...
		 */
		  ...
		  context.getLogService(); IDiagramService diagramService =
		  context.getModelioServices().getDiagramService(); IModelingSession session =
		  context.getModelingSession();
